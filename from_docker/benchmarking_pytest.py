...
class TestBenchmarking: 
    ...
    def test_run_gem5_2(self):
        ...
        for _ in tqdm(range(2)): 
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                tc_2_results = benchmarking.run_gem5(
                    ...
                    cpu_type="Verbatim",
                    bin_path=bin_path, 
                    problem_id=example_2_problem_id, 
                    testcases_dir="/home/pie-perf/data/codenet/merged_test_cases/", 
                    testcases=[0,1], 
                    timeout=30, 
                    cpu_number=0
        ...
        print(f"sim_seconds for tc 0 {sim_seconds_0}")
        print(f"sim_seconds for tc 1 {sim_seconds_1}")
        assert sim_seconds_0[0] == sim_seconds_0[1] == 0.001026564396
        assert sim_seconds_1[0] == sim_seconds_1[1] == 0.001029346032
